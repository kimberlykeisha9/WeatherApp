...
const City = () => {
    ...
    return (
        <SafeAreaView style={container}>
            <ImageBackground
                source={require('../../assets/city.jpg')} style={imageLayout}>
                ...
                <View style={[riseSetWrapper, rowLayout]}>
                    <IconText iconName={'sunrise'} iconColor={'white'} bodyText={'10:46:58'} bodyTextStyles={riseSetText} />
                    <IconText iconName={'sunset'} iconColor={'white'} bodyText={'17:28:15'} bodyTextStyles={riseSetText} />
                </View>
            </ImageBackground>
        </SafeAreaView>
    );
